...
namespace LMS.Models
{
    public class DbOperation
    {
        ...
        public int AddInstructorCourseDb(string courseName, string courseCode, string description, string duration, string category, string language, string createdBy, DateTime creationDateTime)
        {
            string insertCourseQuery = @"
                    INSERT INTO Courses (CourseName, CourseCode, Description, Duration, Category, Language, CreatedBy, CreatedOn)
                    VALUES (@CourseName, @CourseCode, @description, @duration, @category, @language, @CreatedBy, @CreationDate);
        ...
        public List<MasterRecord> GetMasterRecords()
        {
            ...
            string query = "Select * from User_table where UserRole IN ('Learner','Instructor')";
            using (SqlCommand cmd = new SqlCommand(query, Con))
            {
                SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
        ...
        public List<ActiveLearnerModel> GetActiveLearnerList()
        {
        ...
        {
            string query = "select count( distinct learner_id) from LearnerCourse";
            using (SqlCommand cmd = new SqlCommand(query, Con))
            {
                try
                {
